...
amy_err_t esp_amy_init() {
    ...
    xTaskCreatePinnedToCore(&esp_render_task, "render_task0", 8192, &zero, 4, &renderTask[0], 0);
    xTaskCreatePinnedToCore(&esp_render_task, "render_task1", 8192, &one, 4, &renderTask[1], 1);
